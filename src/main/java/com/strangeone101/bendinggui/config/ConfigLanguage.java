...
public class ConfigLanguage extends ConfigBase {
    ...
    public Map<String, Object> addDefaults() {
        ...
        defaults.put("Display.Choose.PermRemoved.Self",
                "You cannot choose an element because your bending has been permanently removed!");
        ...
        defaults.put("Display.Choose.Confirm.Yes.Lore",
                "&7Are you sure you want to choose {elementcolor}{element}&7? This cannot be changed!");
        ...
        defaults.put("Display.Presets.Preset.Lore",
                "&e> {slot1}\\n&e> {slot2}\\n&e> {slot3}\\n&e> {slot4}\\n&e> {slot5}\\n&e> {slot6}\\n&e> {slot7}\\n&e> {slot8}\\n&e> {slot9}");
        ...
        defaults.put("Display.Presets.Global.Lore",
                "&7This is a preset defined by the server\\n\\n&e> {slot1}\\n&e> {slot2}\\n&e> {slot3}\\n&e> {slot4}\\n&e> {slot5}\\n&e> {slot6}\\n&e> {slot7}\\n&e> {slot8}\\n&e> {slot9}");
        ...
        defaults.put("Display.Presets.Create.Confirm.Yes.Lore",
                "&7This will create a new preset using {their|your} current binds");
        ...
        defaults.put("Display.Presets.Delete.On.Lore",
                "&7Delete an existing preset forever\\n\\n&c&lCLICK A PRESET TO DELETE");
        defaults.put("Display.Presets.Delete.Off.Title", "&cDelete a preset &7(Off)");
        defaults.put("Display.Presets.Delete.Off.Lore",
        ...
        defaults.put("Display.Presets.Delete.Confirm.Yes.Lore",
                "&7This will delete the preset forever! (A very long time!)");
        ...
        defaults.put("Display.Presets.Max.Lore",
                "&7You cannot create anymore presets! You must\\n&7delete an existing one before another one\\n&7can be created");

        defaults.put("Display.Edit.Title", "Edit {player|your} elements");
        defaults.put("Display.Edit.Element.Title", "{elementcolor}&l{element}");
        defaults.put("Display.Edit.Element.Lore.Has",
                "&7Click to take away &e{player|your} {elementcolor}{element}{bending}&7!");
        defaults.put("Display.Edit.Element.Lore.HasNot",
                "&7Click to make &e{player|yourself} &7{a} {elementcolor}{element}{bender}&7!");
        ...
        defaults.put("Display.Edit.RemoveAll.Confirm.Yes.Lore",
                "&7Are you sure you want to remove all {player|your} elements?");
        ...
        defaults.put("Display.Main.Info.On.Lore",
                "&7When toggled on, click on an ability for more information.\\n&7Click to turn off again");
        defaults.put("Display.Main.Info.Off.Lore",
                "&7When toggled on, click on an ability for more information.\\n&7Click to turn on");
        defaults.put("Display.Main.Remove.AbilityLore",
                "&c&lTOGGLE THE REMOVAL TOOL BEFORE\\nREBINDING!\\n&r&7You must turn off the unbind tool before you\\ncan rebind moves again");
        ...
        defaults.put("Display.Main.Remove.On.Lore",
                "&7Allows you to remove bound moves to {their|your} slots.\\n&7Click to turn off again\\n&7SHIFT click to remove all your bound moves");
        defaults.put("Display.Main.Remove.Off.Lore",
                "&7Allows you to remove bound moves to {their|your} slots.\\n&7Click to turn on\\n&7SHIFT click to remove all your bound moves");
        defaults.put("Display.Main.Bind.AbilityLore",
        ...
        defaults.put("Display.Main.Slot.Info",
                "&e&lCLICK FOR MORE INFO!\\n&r&7Click to display more information about this move!");
        defaults.put("Display.Main.Slot.Remove",
        ...
        defaults.put("Display.Main.Slot.Offline",
                "&c&lCANNOT MODIFY BENDING OF OFFLINE PLAYERS!\\n&r&7You can't modify the bending of players that are offline!");
        defaults.put("Display.Main.Ability.Selected",
                "&a&lCURRENTLY SELECTED\\n&r&7Click a slot to bind to this move to!");
        defaults.put("Display.Main.Ability.Remove",
                "&c&lTOGGLE THE REMOVAL TOOL BEFORE\\n&c&lREBINDING!\\n&r&7You must turn off the unbind tool before you\\n&7can rebind moves again");
        defaults.put("Display.Main.Ability.Info",
                "&e&lCLICK FOR MORE INFO!\\n&r&7Click to display more information about this move!");
        ...
        defaults.put("Display.Errors.NoAbilName",
                "&4Error: &cMove doesn't exist! Please contact StrangeOne101 about this!");
        defaults.put("Display.Errors.SlotOutOfRange",
                "&cError: Slot binding out of range! Please contact StrangeOne101 about this!");
        defaults.put("Display.Errors.FailedToOpen",
                "&cAn error occurred while trying to open the bending interface. Please report this to your admin or the plugin developer!");
        defaults.put("Display.Errors.NoAbilityDescription",
                "&7\u272F \u272F \u272F This move doesn't have a description set! Bug your server owner about it! \u272F \u272F \u272F");
        defaults.put("Display.Errors.ClickEvent",
                "&cAn error occurred while processing the clickevent. Please report this to your admin or the plugin developer!");
        defaults.put("Display.Errors.CantEditNow", "&cYou cannot edit your binds right now!");
        defaults.put("Display.Errors.Disabled",
                "&cThere is a problem with BendingGUI at the moment. Please contact your admin!");
        ...
        defaults.put("Display.Errors.InvalidPresetName",
                "&cInvalid preset name! It must have no spaces or special characters!");
        ...
        defaults.put("Chat.Choose.PermaRemoved",
                "&cYou cannot choose an element because your bending has been permanently removed!");
        ...
        defaults.put("Chat.Toggle.Player.Off",
                "&cYour bending has been toggled off. You will not be able to use most abilities until you toggle it back.");
        ...
        defaults.put("Chat.Edit.RemoveAll.Self",
                "&cYour elements have been removed! You will need to choose a new element to bend again!");
        ...
        defaults.put("Chat.Presets.Create.Prompt",
                "&ePlease enter the name for {player|your} new preset bellow, or type \"cancel\"!");
        ...
        defaults.put("Chat.Presets.InvalidPresetName",
                "&cInvalid preset name! It must have no spaces or special characters!");
        defaults.put("Chat.Presets.CantBind",
                "&cCannot bind a preset filled with abilities you cannot use! Did you change element?");
        ...
        abilities.put("Torrent",
                "Creates a ring of water around the user which can be used to freeze targets or push them away");
        ...
        abilities.put("Catapult",
                "Allows the user to catapult themselves through the air by launching themselves up from the earth");
        ...
        abilities.put("QuickWeld", "Use the metal in your inventory to repair your metal tools");
        ...
        abilities.put("SwiftKick",
                "Damages the target with a high chance of blocking their chi, if the user is in the air");
        abilities.put("WarriorStance",
                "Makes the user's attacks more powerful but also makes the user more vulnerable");

        abilities.put("AvatarState",
                "Users in the Avatar State are much more powerful than normal benders. Their bending power is multiplied heavily and they take far less damage from attacks.");
        ...
        abilities.put("SonicBlast",
                "Creates an ear-piecing sonicblast that does high damage to other mobs and players");
        ...
        abilities.put("EarthLine",
                "Creates a line of risen earth that inflicts damage on all mobs and players that it hits");
        abilities.put("EarthShard",
                "Allows the user to pickup multiple chunks of earth and hurl them towards their target");
        ...
        abilities.put("MetalHook",
                "Allows the bender to use metalbending to hook or grapple onto a surface and pull themselves in");
        ...
        abilities.put("SpiritBeam",
                "Releases a powerful blast as the spirit of the avatar. The user must be in the AvatarState to use this move.");
        abilities.put("ElementSphere",
                "Creates a sphere of all the elements around the user, allowing them to use all four at once");
        ...
        abilities.put("Alleviate",
                "Heal yourself or others by clearing all negative effects and giving regen and night vision");
        abilities.put("Orb", "Place an orb of positive energy that harms anything that crosses it");
        abilities.put("Combo-Rejuvenate",
                "Mark the ground with positive energy that heals others but damages dark spirits");
        ...
        abilities.put("Strike",
                "Rush up to your target and bite them. This will make you appear above the target instantly");
        abilities.put("Combo-Infest",
                "Mark the ground with chaotic energy that buffs monsters and harms everything else");
        ...
        abilities.put("Combo-Skyrocket",
                "Skyrocket yourself into the air before slamming back to earth with a deadly impact");
        ...
        abilities.put("Combo-Awakening",
                "Summon Light Spirits to your aid that will assist you against other Dark Spirits");
        ...
        abilities.put("Shadow",
                "Transform yourself into the darkness to evade everything as you blip through the darkness instantly");
        abilities.put("Corruption", "Summon Dark Spirits to spread corruption to the land and other spirits");
        abilities.put("Combo-Nightmare",
                "Infect everything around you with negative energy to debuff them for a while");
        abilities.put("Combo-Pandemonium",
                "Corrupts the free will of all entities around you by pulling them towards the center of this ability");
        ...
        abilities.put("Combo-EarthPillars",
                "Send players flying into the air by raising the earth bellow them suddenly");
        ...
        for (Element customSupport : BendingGUI.INSTANCE.getSupportedElements()) {
            ...
            defaults.put("Display.Main.Overview.Element." + support.getElement().getName(),
                    support.getLangOverviewName());

            if (support instanceof ChooseSupport) {
                defaults.put("Display.Choose." + support.getElement().getName() + ".Title",
                        ((ChooseSupport) support).getLangChooseTitle());
                defaults.put("Display.Choose." + support.getElement().getName() + ".Lore",
                        ((ChooseSupport) support).getLangChooseLore());
            }
        }
        ...
        for (Element customElement : Element.getAddonElements()) {
            if (!defaults.containsKey("Display.Main.Overview.Element." + customElement.getName())) {
                ...
                defaults.put("Display.Main.Overview.Element." + customElement.getName(),
                        color + customElement.getName() + customElement.getType().getBender());
            }
        }
        ...
        for (Element.SubElement customSub : Element.getAddonSubElements()) {
            if (!defaults.containsKey("Display.Main.Overview.Element." + customSub.getName())) {
                defaults.put("Display.Main.Overview.Element." + customSub.getName(),
                        customSub.getName() + customSub.getType().getBend());
            }
        }
