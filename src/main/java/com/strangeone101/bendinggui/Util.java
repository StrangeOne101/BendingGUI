...
public class Util 
{
	...
	public static String getStaff(UUID id) {
		...
		else if (id.toString().equals("623df34e-9cd4-438d-b07c-1905e1fc46b6")) return ChatColor.DARK_PURPLE + "ProjectKorra Concept Designer"; // Loony
		...
		//Retired staff
		/*else if (id.toString().equals("5031c4e3-8103-49ea-b531-0d6ae71bad69")) return ChatColor.DARK_PURPLE + "Previous PK Developer";  //Simp
		else if (id.toString().equals("80f9072f-e37e-4adc-8675-1ba6af87d63b")) return ChatColor.DARK_PURPLE + "Previous PK Concept Designer";  // Cross
		...
		else if (id.toString().equals("81adae76-d647-4b41-bfb0-8166516fa189")) return ChatColor.DARK_PURPLE + "Previous PK Developer";  //AlexTheCoder
		...
		else if (id.toString().equals("9c18ff57-04b3-4841-9726-9d64373d0d65")) return ChatColor.DARK_PURPLE + "Previous PK Concept Designer";  //coastyo
		...
		else if (id.toString().equals("9636d66a-bff8-48e4-993e-68f0e7891c3b")) return ChatColor.DARK_PURPLE + "Previous PK Developer";  //Runefist
